...
<div class="author-pane">
 <div class="author-pane-inner">
    <div class="author-pane-name-status author-pane-section">
      ...
      <?php if (!empty($account->profile_country)): ?>
        <div class="author-country"> <?php if (!empty($account->profile_city)): ?> <?php print $account->profile_city; ?>, <?php endif; ?> <?php print $account->profile_country; ?> </div>
      <?php endif; ?>
      <?php if (!empty($account->profile_drupal_mastering_level)): ?>
        <div class="author-country"> <?php print $account->profile_drupal_mastering_level; ?> </div>
      <?php endif; ?>
    </div>
  </div>
</div>
